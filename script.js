...
// clear all text, and hides 5 day forecast
...
// icon codes found at: https://openweathermap.org/weather-conditions
function getSkyIcon(b) {
    ...
    // id 800 = clear, 801 = few clouds, 802 = scattered clouds, 803 = broken clouds, 804 = overcast clouds
    // 01d = sun, 02d = cloud over sun, 03d = cloud, 04d = clouds
    else if (a == 800) {
        return "01d";
    }
    else if (a == 801) {
...
function runSearch(){
    ...
    $.ajax({
        ...
        // get coordinates, necessary for getting UV
